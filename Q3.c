/*
 * Q3. Write a program to obtain the details of n students (Name, Gender, age,
 * CGPA, languages spoken, residence, Bday) using structures and print all the
 * male students more than 18 years old born on 18th March with CGPA > 8.5 who
 * speak Tamil and reside in Vellore.
 */
...
int main(void) {
  ...
  for (i = 0; i < no_of_students; ++i) {
    ...
    int passed_bool = 0;
    if ((students[i].gender == 'M') && (students[i].age > 18) &&
        !(strcmp(students[i].Bday, "18/03")) && (students[i].CGPA > 8.5) &&
